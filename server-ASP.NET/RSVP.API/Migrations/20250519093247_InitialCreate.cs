...
namespace RSVP.API.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "Description", "Duration", "Name", "Price", "ServiceId", "StoreId" },
                values: new object[,]
                {
                    { 1, null, 30, "Haircut", 30.00m, "service-1", "store-1" },
                    { 2, null, 120, "Hair Coloring", 80.00m, "service-2", "store-1" }
                });
